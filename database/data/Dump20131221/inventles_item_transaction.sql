...
CREATE TABLE `item_transaction` (
  ...
  KEY `fk_item_transaction_item1_idx` (`item_id`),
  CONSTRAINT `fk_item_transaction_item1` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
