...
CREATE TABLE `customer` (
  ...
  KEY `fk_customer_entity1_idx` (`entity_code`),
  CONSTRAINT `fk_customer_entity1` FOREIGN KEY (`entity_code`) REFERENCES `business_entity` (`entity_code`) ON DELETE NO ACTION ON UPDATE NO ACTION
